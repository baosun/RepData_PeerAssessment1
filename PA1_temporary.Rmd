...
```
mean of total number of steps taken each day is `r mymean`.  
median of total number of steps taken each day is `r mymedian`.
...
The `r a`th interval contains the maximum number of steps.
...
```
After filling missing values, the new mean is `r newmean`, the new median is `r newmedian`.  
